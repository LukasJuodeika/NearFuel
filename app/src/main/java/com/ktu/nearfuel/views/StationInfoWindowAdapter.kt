...
class StationInfoWindowAdapter(private val mContext: Context) : GoogleMap.InfoWindowAdapter {
    ...
    private var mWindow: View =
        LayoutInflater.from(mContext).inflate(R.layout.station_info_window, null)
    ...
    private fun renderWindowText(marker: Marker, view: View) {
        ...
        if (station.diesel_price == null) {
            ...
            view.iw_diesel_price.text =
                resources.getString(R.string.iw_diesel, station.diesel_price)
